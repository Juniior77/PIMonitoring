...
public class MySQLite extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_MONITORING = "" +
            "CREATE TABLE IF NOT EXISTS MONITORING(ID TEXT, NOM TEXT, DATE TEXT, N_STEP INTEGER, CPU INTEGER, RAM INTEGER, TEMP INTEGER);";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        // On créer la table MONITORING si elle existe pas
